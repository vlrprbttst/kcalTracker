(() => {
  ...
  function SettingsOverlay({ open, setOpen, wizardOpen, draft, setDraft, onSave, lightTheme, setLightTheme, scrollToKcal }) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "settings-body" }, /* @__PURE__ */ React.createElement("section", { className: "settings-section" }, /* @__PURE__ */ React.createElement("h2", { className: "settings-section-title" }, "Tema"), /* @__PURE__ */ React.createElement("div", { className: "settings-field" }, /* @__PURE__ */ React.createElement("span", { className: "settings-label" }, "Aspetto"), /* @__PURE__ */ React.createElement("div", { className: "settings-theme-toggle" }, /* @__PURE__ */ React.createElement(
        "button",
        {
  ...
  var WIZARD_STEPS = [
    {
      ...
      text: "Questa guida ti mostra le funzionalit\xE0 principali dell'app. Premi Avanti per iniziare."
    },
    {
      tab: null,
    ...
    },
    {
      ...
      text: "\u274C reset azzera tutte le calorie del giorno corrente. A sinistra, 'chiudi tutto' chiude l'accordion aperto \u2014 compare solo quando ce n'\xE8 uno aperto."
    },
    {
      tab: "oggi",
      selector: ".category-card",
    ...
    },
    {
      tab: null,
      openSettings: true,
      selector: ".settings-theme-toggle",
      title: "Tema",
    ...
    },
    {
      tab: null,
      openSettings: true,
      selector: "[data-wizard='settings-kcal']",
    ...
    },
    {
      tab: null,
      openSettings: true,
      selector: "[data-wizard='settings-orari']",
      last: true,
      title: "Fasce orarie",
  ...
  function Wizard({ open, step, setStep, setOpen, setActiveTab, activeTab }) {
  ...
  function TrackerTab({
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, user && /* @__PURE__ */ React.createElement("div", { className: "tracker-toolbar" }, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "chiudi tutto"
    ), /* @__PURE__ */ React.createElement("button", { className: "reset-btn", onClick: onReset, "aria-label": "Azzera le calorie di oggi" }, "\u274C reset")), user && (() => {
  ...
  function App() {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("a", { href: "#main-content", className: "skip-link" }, "Vai al contenuto principale"), /* @__PURE__ */ React.createElement(ConfirmModal, { modal: confirmModal, onClose: () => setConfirmModal(null) }), notAllowed && /* @__PURE__ */ React.createElement("div", { className: "modal-overlay", role: "dialog", "aria-modal": "true", "aria-labelledby": "modal-title" }, /* @__PURE__ */ React.createElement("div", { className: "modal" }, /* @__PURE__ */ React.createElement("img", { src: "no.gif", alt: "", role: "presentation", style: { width: 313, maxWidth: "100%", height: "auto", borderRadius: 8, marginBottom: 12 } }), /* @__PURE__ */ React.createElement("div", { id: "modal-title", className: "modal-title" }, "Accesso non disponibile"), /* @__PURE__ */ React.createElement("div", { className: "modal-text" }, "Gli slot disponibili sono esauriti. Riprova pi\xF9 avanti."), /* @__PURE__ */ React.createElement("button", { className: "modal-btn", onClick: () => setNotAllowed(false) }, "Ok, capito"))), /* @__PURE__ */ React.createElement("div", { className: "sticky-top" }, /* @__PURE__ */ React.createElement("header", { className: "header" }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 520, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { className: "header-top" }, /* @__PURE__ */ React.createElement("img", { src: "logo-main-horizontal.png", alt: "kcalTracker", className: "app-logo" }), /* @__PURE__ */ React.createElement("div", { className: "header-top-right" }, user === void 0 ? null : user ? /* @__PURE__ */ React.createElement("div", { className: "profile-menu-wrap", ref: profileMenuRef }, user.displayName && /* @__PURE__ */ React.createElement("span", { className: "auth-name" }, user.displayName), /* @__PURE__ */ React.createElement("button", { className: "auth-btn logged", onClick: () => setProfileMenuOpen((v) => !v), "aria-label": "Menu profilo", "aria-expanded": profileMenuOpen, "aria-haspopup": "menu" }, user.photoURL && /* @__PURE__ */ React.createElement("img", { src: user.photoURL, className: "auth-avatar", alt: "" })), profileMenuOpen && /* @__PURE__ */ React.createElement("div", { className: "profile-dropdown", role: "menu" }, /* @__PURE__ */ React.createElement("button", { className: "profile-menu-item", role: "menuitem", onClick: () => {
    ...
    } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F4E4}"), " Condividi"), pwaInteracted && !(window.matchMedia("(display-mode: standalone)").matches || window.navigator.standalone) && /* @__PURE__ */ React.createElement("button", { className: "profile-menu-item", role: "menuitem", onClick: () => {
      setProfileMenuOpen(false);
      if (installEvent) {
        handleInstall();
      } else {
    ...
    } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F4F2}"), " Installa"), /* @__PURE__ */ React.createElement("button", { className: "profile-menu-item profile-menu-item-logout", role: "menuitem", onClick: () => {
      setProfileMenuOpen(false);
      logout();
    } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F6AA}"), " Logout"))) : /* @__PURE__ */ React.createElement("button", { className: "auth-btn", onClick: login }, "Accedi"))), /* @__PURE__ */ React.createElement("div", { className: "kcal-row", "aria-live": "polite", "aria-atomic": "true" }, /* @__PURE__ */ React.createElement("span", { className: `kcal-consumed${shakeTarget ? " shake" : ""}`, style: { color: barColor } }, totalKcal), /* @__PURE__ */ React.createElement("span", { className: "kcal-sep" }, "/"), user ? /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React.createElement("span", { className: "kcal-target" }, target),
      /* @__PURE__ */ React.createElement("span", { className: "kcal-label" }, "kcal")
    ) : /* @__PURE__ */ React.createElement("span", { className: "kcal-target-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "kcal-target", "aria-label": `Obiettivo calorico: ${target} kcal` }, target), /* @__PURE__ */ React.createElement("span", { className: "kcal-label" }, "kcal")), /* @__PURE__ */ React.createElement("span", { className: "kcal-remaining" }, remaining >= 0 ? `${remaining} rimanenti` : `${Math.abs(remaining)} in eccesso`)), /* @__PURE__ */ React.createElement("div", { className: "progress-track" }, /* @__PURE__ */ React.createElement("div", { className: "progress-bar", style: { width: `${pct}%`, background: barColor } })))), user && /* @__PURE__ */ React.createElement("div", { className: "tabs-bar", role: "navigation", "aria-label": "Sezioni principali" }, /* @__PURE__ */ React.createElement("div", { className: "tabs-inner" }, /* @__PURE__ */ React.createElement("button", { ref: (el) => tabRefs.current["oggi"] = el, className: `tab-btn${activeTab === "oggi" ? " active" : ""}`, onClick: () => setActiveTab("oggi") }, "Menu"), log.length > 0 && /* @__PURE__ */ React.createElement("button", { ref: (el) => tabRefs.current["menu"] = el, className: `tab-btn${activeTab === "menu" ? " active" : ""}`, onClick: () => setActiveTab("menu") }, "Oggi"), /* @__PURE__ */ React.createElement("button", { ref: (el) => tabRefs.current["storico"] = el, "data-wizard": "storico-tab", className: `tab-btn${activeTab === "storico" ? " active" : ""}`, onClick: () => setActiveTab("storico") }, "Storico"), /* @__PURE__ */ React.createElement("button", { ref: (el) => tabRefs.current["alimenti"] = el, "data-wizard": "alimenti-tab", className: `tab-btn${activeTab === "alimenti" ? " active" : ""}`, onClick: () => setActiveTab("alimenti") }, "Alimenti"), /* @__PURE__ */ React.createElement("div", { className: "tab-indicator", style: { left: indicatorStyle.left, width: indicatorStyle.width } }))), user && activeTab === "oggi" && /* @__PURE__ */ React.createElement("div", { className: "sticky-search" }, /* @__PURE__ */ React.createElement("div", { className: "search-wrap" }, /* @__PURE__ */ React.createElement(
      "input",
      {
